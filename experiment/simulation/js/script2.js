...
function draw() {
  ...
  document.getElementById("titleincanvas").innerHTML = "Position Analysis";
...
function drawvel(ctx) {
  ...
  document.getElementById("vc").style.left =
    "" + (-10 + Math.round(60 + va.xcoord + vc.xcoord) / 2) + "px";
  document.getElementById("vc").style.top =
    "" + (-10 + Math.round(200 + va.ycoord + vc.ycoord) / 2) + "px";
  document.getElementById("vb").style.left =
    "" + (-10 + Math.round(60 + va.xcoord + vb.xcoord) / 2) + "px";
  document.getElementById("vb").style.top =
    "" + (-10 + Math.round(200 + va.ycoord + vb.ycoord) / 2) + "px";
  document.getElementById("ve").style.left =
    "" + (-10 + Math.round(60 + ve.xcoord + va.xcoord) / 2) + "px";
  document.getElementById("ve").style.top =
    "" + (-10 + Math.round(760) / 2) + "px";
  document.getElementById("vd").style.left =
    "" + (-10 + Math.round(60 + va.xcoord + vd.xcoord) / 2) + "px";
  document.getElementById("vd").style.top =
    "" + (-10 + Math.round(200 + va.ycoord + vd.ycoord) / 2) + "px";
  document.getElementById("vde").style.left =
    "" + (-10 + Math.round(60 + ve.xcoord + vd.xcoord) / 2) + "px";
  document.getElementById("vde").style.top =
    "" + (-10 + Math.round(200 + ve.ycoord + vd.ycoord) / 2) + "px";
  document.getElementById("vbc").style.left =
    "" + (-10 + Math.round(60 + vb.xcoord + vc.xcoord) / 2) + "px";
  document.getElementById("vbc").style.top =
    "" + (-10 + Math.round(200 + vb.ycoord + vc.ycoord) / 2) + "px";
...
function drawacc(ctx) {
  ...
  document.getElementById("ac").style.left =
    "" + (-10 + Math.round(60 + aa.xcoord + ac.xcoord) / 2) + "px";
  document.getElementById("ac").style.top =
    "" + (-10 + Math.round(200 + aa.ycoord + ac.ycoord) / 2) + "px";
  document.getElementById("ad").style.left =
    "" + (-10 + Math.round(60 + aa.xcoord + ad.xcoord) / 2) + "px";
  document.getElementById("ad").style.top =
    "" + (-10 + Math.round(200 + aa.ycoord + ad.ycoord) / 2) + "px";
  document.getElementById("ab").style.left =
    "" + (-10 + Math.round(60 + aa.xcoord + ab.xcoord) / 2) + "px";
  document.getElementById("ab").style.top =
    "" + (-10 + Math.round(200 + aa.ycoord + ab.ycoord) / 2) + "px";
  document.getElementById("ae").style.left =
    "" + (-10 + Math.round(60 + aa.xcoord + ae.xcoord) / 2) + "px";
  document.getElementById("ae").style.top =
    "" + (-10 + Math.round(710) / 2) + "px";
  document.getElementById("aca").style.left =
    "" + (-10 + Math.round(60 + abc.xcoord + ap.xcoord) / 2) + "px";
  document.getElementById("aca").style.top =
    "" + (-10 + Math.round(200 + abc.ycoord + ap.ycoord) / 2) + "px";
  document.getElementById("acb").style.left =
    "" + (-10 + Math.round(60 + ab.xcoord + abc.xcoord) / 2) + "px";
  document.getElementById("acb").style.top =
    "" + (-10 + Math.round(200 + ab.ycoord + abc.ycoord) / 2) + "px";
  document.getElementById("ap").style.left =
    "" + (-10 + Math.round(60 + ac.xcoord + ap.xcoord) / 2) + "px";
  document.getElementById("ap").style.top =
    "" + (-10 + Math.round(200 + ac.ycoord + ap.ycoord) / 2) + "px";
  document.getElementById("abc").style.left =
    "" + (-10 + Math.round(60 + abc.xcoord + ac.xcoord) / 2) + "px";
  document.getElementById("abc").style.top =
    "" + (-10 + Math.round(200 + abc.ycoord + ac.ycoord) / 2) + "px";
  document.getElementById("aed").style.left =
    "" + (-10 + Math.round(60 + ae.xcoord + ad.xcoord) / 2) + "px";
  document.getElementById("aed").style.top =
    "" + (-10 + Math.round(200 + ae.ycoord + ad.ycoord) / 2) + "px";
  document.getElementById("ax").style.left =
    "" + (-10 + Math.round(60 + aed.xcoord + ad.xcoord) / 2) + "px";
  document.getElementById("ax").style.top =
    "" + (-10 + Math.round(200 + aed.ycoord + ad.ycoord) / 2) + "px";
  document.getElementById("ay").style.left =
    "" + (-10 + Math.round(60 + aed.xcoord + ae.xcoord) / 2) + "px";
  document.getElementById("ay").style.top =
    "" + (-10 + Math.round(200 + aed.ycoord + ae.ycoord) / 2) + "px";
